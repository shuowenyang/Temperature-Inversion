...
T_test = [];
for i = 1:1
    temp_input = data_output((i-1)*22356+1:i*22356,:);
    temp_output = data_output_K((i-1)*22356+1:i*22356,:);
    n = randperm(22356);
    % 训练集——20个样本
    P_train = [P_train temp_input(n(1:21000),:)'];
    T_train = [T_train temp_output(n(1:21000),:)'];
    % 测试集——2个样本
    P_test = [P_test temp_input(n(21001 : 22356),:)'];
    T_test = [T_test temp_output(n(21001 : 22356),:)'];
end
