...
% net_bp=newff(p_train,t_train,[4,4],);
% net_bp=newff(p_train,t_train,[10,10,10,10],{'tansig','purelin'},'trainlm');
net_bp=newff(p_train,t_train,[6,6],{'tansig','purelin'},'trainlm');
net_bp.trainParam.epochs = 500; % 训练轮次设置为100
% net_bp.trainParam.miniBatchSize = 100;
net_bp.trainParam.lr = 0.01; % 初始学习率设置为0.001
...
% save D_BP T_sim1 T_train T_sim2 T_test error_BP;
figure
...
% save C_BP T_sim1 T_train T_sim2 T_test error_BP;
