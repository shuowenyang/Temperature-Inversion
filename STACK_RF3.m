...
net_bp=newff(p_train,t_train,[4,4,4],{'tansig','purelin'},'trainlm');
...
X_stack = [train_cnn;train_grnn;train_bp];
X_stack_test = [test_cnn;test_grnn;test_bp];
...
net_stack.divideParam.trainRatio = 70/100;
net_stack.divideParam.valRatio = 15/100;
net_stack.divideParam.testRatio = 15/100;
...
T_p = (T_test_bp + T_test_grnn + T_test_cnn) ./3;
