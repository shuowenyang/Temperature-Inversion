...
plot(1: 90, a, 'r-o', 1: 90, b, 'g-+',1:90,c,'b-*',1:90,d,'c-.',1:90,e,'k-^','LineWidth',2);
% plot(1: N, error_B, 'r-o', 1: N, error_GRNN, 'g-+',1:N,error_RBF,'b-*',1:N,error_resCNN,'c-.',1:N,error_Me,'k-^');
% plot(1: N, error_B, 'r-o', 1: N, error_GRNN, 'g-+',1:N,error_RBF,'b-*',1:N,error_resCNN,'c-.',1:N,error_Me,'k-^');
% plot(1: N, error_B, 'r-o', 1: N, error_GRNN, 'g-+',1:N,error_RBF,'b-*',1:N,error_resCNN,'c-.',1:N,error_Me,'k-^');
% scatter(X, error_B, 'ro', X, error_GRNN, 'g+',X,error_RBF,'b*',X,error_resCNN,'c.',X,error_Me,'k^');
legend('BP误差绝对值','GRNN误差绝对值','RBF误差绝对值','ResCNN误差绝对值','本章算法误差绝对值','FontSize',16,'location','best');
% legend('GRNN误差绝对值');
% legend('RBF误差绝对值');
% legend('resCNN误差绝对值');
% legend('本章算法误差绝对值');
xlabel('A类样本编号','FontSize',14);
ylabel('误差绝对值 / K','FontSize',14);
% string = {'BP测试集样本误差绝对值'};
% title(string);
set(gca,'FontSize',16);
