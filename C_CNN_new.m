...
tempLayers = [
    convolution2dLayer([2 2],16,"Name","conv","Padding","same")
    batchNormalizationLayer("Name","batchnorm")
    reluLayer("Name","relu")
    maxPooling2dLayer([1 1],"Name","maxpool","Padding","same")
    convolution2dLayer([2 2],16,"Name","conv_1","Padding","same")
    batchNormalizationLayer("Name","batchnorm_1")
    reluLayer("Name","relu_1")
    maxPooling2dLayer([1 1],"Name","maxpool_1","Padding","same")
...
lgraph = connectLayers(lgraph,"relu_2","addition/in1");
%%  参数设置
